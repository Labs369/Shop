# main.py — КАРТОЧНЫЙ МАГАЗИН В TELEGRAM (финальная рабочая версия)
# + Добавление товаров из чата
# + Без ошибок edit_media
...
# ГЛАВНАЯ ФУНКЦИЯ — ВСЕГДА ОТПРАВЛЯЕТ НОВОЕ СООБЩЕНИЕ
